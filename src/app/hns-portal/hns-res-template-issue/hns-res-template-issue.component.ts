...
@Component({
  selector: 'app-hns-res-template-issue',
  templateUrl: './hns-res-template-issue.component.html',
  styleUrls: ['./hns-res-template-issue.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class HnsResTemplateIssueComponent implements OnInit {
  ...
  selectedNode: any
  @Output() selectRowIss = new EventEmitter<any>();
  ...
  ngOnInit() {
    this.selectedNode = this.selectedAction
  ...
  selectIssue() {
    this.selectRowIss.emit(this.selectedTemplateIssue);
    this.closeTemplateIssueMethod();
  }

...
@Component({
  selector: 'app-hns-res-upload-ans-image',
  templateUrl: './hns-res-upload-ans-image.component.html',
  styleUrls: ['./hns-res-upload-ans-image.component.css']
})
export class HnsResUploadAnsImageComponent implements OnInit {

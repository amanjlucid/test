...
import { SettingsService, LoaderService, AlertService } from '../_services';


@Component({
  selector: 'app-hns-report-images',
  templateUrl: './hns-report-images.component.html',
  styleUrls: ['./hns-report-images.component.css'],

})
export class HnsReportImagesComponent implements OnInit {
  @Input() showReportImages: boolean = false;
  @Output() closeReportImages = new EventEmitter<boolean>();
  ...
  closeUploadAttachmentWin() {
    this.showReportImages = false;
    this.closeReportImages.emit(this.showReportImages);
  }

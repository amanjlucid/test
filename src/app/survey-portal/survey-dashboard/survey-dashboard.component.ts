...
import { AlertService, HelperService, SharedService, HnsPortalService, EventManagerDashboardService, SurveyPortalService } from '../../_services'
      ...
      this.subs.add(
        ...
        this.hnsPortalService.getUserChartData(this.currentUser.userId, this.portalName).subscribe(
          data => {
            ...
            this.subs.add(
              this.surveyPortalService.GetSurveyingChartsList().subscribe(
                data => {
                  if (data.isSuccess) {

! function($) {
    ...
    lm.utils.F = function() {}, lm.utils.extend = function(t, e) {
            ...
            this._mSubscriptions = {}, this._mSubscriptions[lm.utils.EventEmitter.ALL_EVENT] = [], this.on = function(t, e, i) {
                ...
                if (n = Array.prototype.slice.call(arguments, 1), this._mSubscriptions[t])
                    for (e = 0; e < this._mSubscriptions[t].length; e++) i = this._mSubscriptions[t][e].ctx || {}, this._mSubscriptions[t][e].fn.apply(i, n);
            ...
            lm.utils.EventEmitter.call(this), this.isInitialised = !1, this._isFullPage = !1, this._resizeTimeoutId = null, this._components = {
        ...
        function() {
            ...
            _updateTabSizes: function() {
                if (0 !== this.tabs.length) {
                    ...
                    var e, i, n, s, o = this.element.outerWidth() - this.controlsContainer.outerWidth() - this._tabControlOffset,
                        r = 0,
                        a = !1;
            ...
            removeChild: function(t, e) {
                var i, n, s = t.config[this._dimension],
            ...
            _respectMinItemWidth: function() {
                var t, e, n, s = this.layoutManager.config.dimensions ? this.layoutManager.config.dimensions.minItemWidth || 0 : 0,
                    o = null,
                    r = [],
                    a = 0,
                    h = 0,
                ...
                if (!(this._isColumn || !s || this.contentItems.length <= 1)) {
                    for (o = this._calculateAbsoluteSizes(), i = 0; i < this.contentItems.length; i++) c = this.contentItems[i], m = o.itemSizes[i], m < s ? (h += s - m, n = {
                        width: s
                    }) : (a += m - s, n = {
                        width: m
                    }, r.push(n)), d.push(n);
            ...
            _$onDrop: function(t) {
                ...
                t.isComponent && (i = this.layoutManager.createContentItem({
                    type: "stack",
                    header: t.config.header || {}
                }, this), i._$init(), i.addChild(t), t = i), a ? (e = lm.utils.indexOf(this, this.parent.contentItems), this.parent.addChild(t, r ? e : e + 1, !0), this.config[l] *= .5, t.config[l] = this.config[l], this.parent.callDownwards("setSize")) : (h = s ? "column" : "row", n = this.layoutManager.createContentItem({
                    type: h
                }, this), this.parent.replaceChild(this, n), n.addChild(t, r ? 0 : void 0, !0), n.addChild(this, r ? void 0 : 0, !0), this.config[l] = 50, t.config[l] = 50, n.callDownwards("setSize"))
            },
            _$highlightDropZone: function(t, e) {
                var i, n;
                for (i in this._contentAreaDimensions)
                    if (n = this._contentAreaDimensions[i].hoverArea, n.x1 < t && n.x2 > t && n.y1 < e && n.y2 > e) return void("header" === i ? (this._dropSegment = "header", this._highlightHeaderDropZone(this._sided ? e : t)) : (this._resetHeaderDropZone(), this._highlightBodyDropZone(i)))
            },
            _$getArea: function() {
            ...
            _highlightHeaderDropZone: function(t) {
                var e, i, n, s, o, r, a, h, l, m = this.header.tabs.length,
                    c = !1;

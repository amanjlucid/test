...
import { SharedService, HnsResultsService, HelperService, AlertService } from '../../_services';
              ...
              this.hnsResultService.runReport(reportParams).subscribe(
                data => {
                  if (data.isSuccess && data.data.length > 0) {
                    ...
                    const fileName = `PropertyReport_${this.selectedAction.hasassessmentref}_${this.selectedAction.hasversion}_${this.selectedAction.assid}.pdf`;

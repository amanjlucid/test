...
@Component({
  selector: 'app-hns-res-template-action',
  templateUrl: './hns-res-template-action.component.html',
  styleUrls: ['./hns-res-template-action.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class HnsResTemplateActionComponent implements OnInit {
  ...
  selectAction() {
    this.selectedRow.emit(this.selectedTemplateAction);
    this.closeTemplateActionMethod()
  }

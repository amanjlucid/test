export class WopmChecklistMasterModel {
    constructor(public wotsequence : number, public wochecksurcde : number, public wostagesurcde : number, public displaysequence : number,
